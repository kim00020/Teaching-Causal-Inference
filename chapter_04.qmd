...
(c) Use d-separation in $\mathcal{G}(t)$ to verify that $(Y(t) \indep T \mid X)_{\mathcal{G}(t)}$ holds. Conclude that $X$ satisfies the back-door criterion, confirming @prp-ign-bd.
