...
::: {.callout-note icon=false}
## Example: Ordinary Least Squares {#exm-ols}
...
::: {.callout-note icon=false}
## Example: A Simple IPW Estimating Equation {#exm-ipw-ee}
...
::: {.callout-note icon=false}
## Definition: Asymptotic Linearity and Influence Function {#def-asymlin}
...
## Proposition: Generic First-Order Expansion {#prp-expansion}
...
::: {.callout-note icon=false}
## Definition: Influence Function of an Estimator (informal) {#def-if}
...
::: {.callout-note icon=false}
## Definition: Pathwise Gradient of a Functional (informal) {#def-gradient}
...
## Example (second reading): OLS Slope by Contamination Derivative {#exm-if-ols}
...
::: {.callout-tip icon=false}
## Theorem: Z-Estimation Theorem (Stacked Equations) {#thm-zest}
...
::: {.callout-note icon=false}
## Example: Ratio of Means {#exm-ratio}
...
::: {.callout-note collapse=true icon=false}
## Example (advanced): Variance of IPW with Estimated Propensity Score {#exm-ipw-var}
...
::: {.callout-tip icon=false}
## Proposition: Variance from the Influence Function {#prp-variance}
...
::: {.callout-note icon=false}
## Definition: Efficient Influence Function (canonical gradient) {#def-eif}
...
::: {.callout-tip icon=false}
## Theorem: Semiparametric Convolution Theorem {#thm-convolution}
