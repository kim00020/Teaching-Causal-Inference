...
**5. Theorem for the collider.** Consider the collider $A \to M \leftarrow B$ with Markov factorization $p(a, m, b) = p(a)\,p(b)\,p(m \mid a, b)$.
...
(e) Does conditioning on $D$ (a descendant of $C$) open the path $X_1 \to C \leftarrow M_2$? State which clause of Definition 2.1 applies.
