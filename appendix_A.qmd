...
## Definition: Conditional Independence {#def-appA-ci}
...
## Proposition: Fundamental Properties of Conditional Independence {#prp-appA-ci-axioms}
...
::: {.callout-note icon=false}
## Example: Ice Cream, Drowning, and Season {#exm-appA-icecream}
...
::: {.callout-note icon=false}
## Example: Exercise, Body Weight, and Blood Pressure {#exm-appA-chain}
...
::: {.callout-note icon=false}
## Example: Ice Cream, Season, and Drowning {#exm-appA-fork}
...
::: {.callout-note icon=false}
## Example: Talent, Legacy Status, and College Admission {#exm-appA-collider}
...
::: {.callout-note icon=false}
## Definition: Blocked Path {#def-appA-blocked}
...
::: {.callout-note icon=false}
## Definition: $d$-Separation {#def-appA-dsep}
...
::: {.callout-note icon=false}
## Definition: DAG Factorization {#def-appA-factorization}
...
::: {.callout-note icon=false}
## Example: A Simple Confounding Graph {#exm-appA-factorization}
...
::: {.callout-note icon=false}
## Definition: Local Markov Property {#def-appA-local-markov}
...
::: {.callout-tip icon=false}
## Theorem: Equivalence of the Three Markov Properties [@lauritzen1996graphical, Theorem 3.27] {#thm-appA-markov-equiv}
...
::: {.callout-note icon=false}
## Example: Education--Earnings Graph {#exm-appA-education}
...
::: {.callout-note icon=false}
## Example: Moral Graph of a Collider {#exm-appA-moral}
